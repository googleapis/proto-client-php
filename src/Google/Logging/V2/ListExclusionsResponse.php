...
class ListExclusionsResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.logging.v2.LogExclusion exclusions = 1;</code>
     * @param \Google\Logging\V2\LogExclusion[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setExclusions($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Logging\V2\LogExclusion::class);
        $this->exclusions = $arr;
