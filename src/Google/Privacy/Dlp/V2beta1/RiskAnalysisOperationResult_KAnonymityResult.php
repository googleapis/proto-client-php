...
class RiskAnalysisOperationResult_KAnonymityResult extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.RiskAnalysisOperationResult.KAnonymityResult.KAnonymityHistogramBucket equivalence_class_histogram_buckets = 5;</code>
     * @param \Google\Privacy\Dlp\V2beta1\RiskAnalysisOperationResult_KAnonymityResult_KAnonymityHistogramBucket[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setEquivalenceClassHistogramBuckets($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Privacy\Dlp\V2beta1\RiskAnalysisOperationResult_KAnonymityResult_KAnonymityHistogramBucket::class);
