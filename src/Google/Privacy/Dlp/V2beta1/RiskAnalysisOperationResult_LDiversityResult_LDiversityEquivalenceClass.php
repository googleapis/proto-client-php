...
class RiskAnalysisOperationResult_LDiversityResult_LDiversityEquivalenceClass extends \Google\Protobuf\Internal\Message
{
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.Value quasi_ids_values = 1;</code>
     * @param \Google\Privacy\Dlp\V2beta1\Value[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setQuasiIdsValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Privacy\Dlp\V2beta1\Value::class);
     ...
     *
     * Generated from protobuf field <code>repeated .google.privacy.dlp.v2beta1.ValueFrequency top_sensitive_values = 4;</code>
     * @param \Google\Privacy\Dlp\V2beta1\ValueFrequency[]|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTopSensitiveValues($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Google\Privacy\Dlp\V2beta1\ValueFrequency::class);
